import { IConfigurationExtend, IConfigurationModify, IEnvironmentRead, IHttp, IRead } from '@rocket.chat/apps-engine/definition/accessors';
import { App } from '@rocket.chat/apps-engine/definition/App';
import { ISetting } from '@rocket.chat/apps-engine/definition/settings';
import { AppSetting, settings } from './src/settings';

import { JitsiSlashCommand } from './src/slashcommand';
import { JitsiProvider } from './src/videoConfProvider';
