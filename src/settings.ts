...
export enum AppSetting {
	...
	JitsiTokenType = 'jitsi_token_type',
	JitsiJWT = 'jitsi_jwt',
...
export const settings: Array<ISetting> = [
	...
	{
		id: AppSetting.JitsiTokenType,
		type: SettingType.SELECT,
		packageValue: 'none',
		required: false,
		public: true,
		i18nLabel: AppSetting.JitsiTokenType,
		i18nDescription: `${AppSetting.JitsiTokenType}_description`,
		values: [
			{
				key: 'none',
				i18nLabel: `${AppSetting.JitsiTokenType}_none`,
			},
			{
				key: 'static',
				i18nLabel: `${AppSetting.JitsiTokenType}_static`,
			},
			{
				key: 'generate',
				i18nLabel: `${AppSetting.JitsiTokenType}_generate`,
			},
		],
	},
	{
